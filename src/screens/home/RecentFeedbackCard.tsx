...
function ReadyFeedbackCard({
  ...
  return (
    <Pressable
      ...
      className="mt-3 flex-row items-center justify-between rounded-card bg-surface p-card"
      style={shadows.card}
...
function LoadingFeedbackCard() {
  return (
    <View
      ...
      className="mt-3 min-h-40 items-center justify-center rounded-card bg-surface p-card"
      style={shadows.card}
    >
