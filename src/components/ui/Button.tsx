...
const VARIANT_STYLES = {
  ...
  /**
   * 되돌릴 수 없는 선택 — 확인 모달의 "삭제", "나가기"처럼 **되돌아갈 길이 나란히
   * 놓인 상태에서** 파괴적인 쪽을 고르는 자리.
   *
   * 나가기가 곧 유일한 회복 수단인 화면(시험 정보를 못 불러온 오류 화면, 음성 재생
   * 실패 안내)에서는 danger가 아니라 `primary`다. 그건 파괴가 아니라 그 화면이
   * 기대하는 행동이다. 무엇을 하느냐가 아니라 **옆에 대안이 있느냐**가 기준이다.
   *
